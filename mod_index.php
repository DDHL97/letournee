...
<body>
    ...
    <div class="row">
        <div class="col-md-5 col-md-offset-3">
            ...
            <form class="form-signin" method="post" action="insert_index.php"  enctype="multipart/form-data">
                <label for="nombrepueblo" class="sr-only">Nombre Pueblo</label>
                <input type="text" name="pueblo" class="form-control" placeholder="Nombre del pueblo magico" required autofocus>
                <label for="ldescripcion" class="sr-only">Bienvenida</label>
                <textarea type="text" name="bienvenida" class="form-control" placeholder="Bienvenida" rows="10" cols="40" required></textarea>
                <label for="imagen">Subir imagen del pueblo magico</label>
                <input type="file" size=60 name="img_pueblo">
                <input type="submit" class="btn btn-lg btn-primary btn-block" value = "Agregar a inicio">
            </form>
        </div>
    </div>
</div>
