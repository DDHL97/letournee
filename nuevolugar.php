...
<body>
    ...
    <div class="row">
        <div class="col-md-5 col-md-offset-3">
            ...
            <form class="form-signin" method="post" action="insertarlugar.php" enctype="multipart/form-data">
                <label for="nombrepueblo" class="sr-only">Nombre lugar de interes</label>
                <input type="text" name="nombre" class="form-control" placeholder="Nombre del Lugar de interes" required autofocus>
                ...
                <label for="nombrepueblo" class="sr-only">Nombre lugar de interes</label>
                <input type="text" name="posicionx" class="form-control" placeholder="Posicion x" required autofocus>
                <label for="nombrepueblo" class="sr-only">Nombre lugar de interes</label>
                <input type="text" name="posiciony" class="form-control" placeholder="Posicion y" required autofocus>
